...
if (GMock_DIR)
 ...
 find_library (
    GMock_DEBUG_LIBRARY
       ...
       HINTS         "${GMock_DIR}"
      PATH_SUFFIXES "lib"
      DOC           "Link library for debug Google Mock (gmock)."
      NO_DEFAULT_PATH
  )
 ...
 find_library (
    GMock_DEBUG_LIBRARY
       NAMES gmockd
       HINTS ENV LD_LIBRARY_PATH
       DOC  "Link library for debug google mock"
  )
endif ()
...
set(GMock_Lib debug ${GMock_DEBUG_LIBRARY} optimized ${GMock_LIBRARY})
#© Copyright 2012, University of Pennsylvania. Last updated on Fri Jun 1 2012 21:23:32. Created using Doxygen 1.7.5.1. 